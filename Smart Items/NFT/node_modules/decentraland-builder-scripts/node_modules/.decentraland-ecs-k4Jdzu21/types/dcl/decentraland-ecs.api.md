...
// Warning: (ae-forgotten-export) The symbol "PositionType" needs to be exported by the entry point index.d.ts
// 
// @public
export function movePlayerTo(position: PositionType, cameraTarget?: PositionType): void;
